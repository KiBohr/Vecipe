...
const Login = () => {
   ...
   return ( 
    <section>
        ...
        <form onSubmit={handleLogin} className="text-blue bg-white/70 mx-5  md:mx-40 md:text-xl md:gap-4 lg:mx-60 lg:text-2xl lg:gap-6 lg:items-center my-35 p-5 rounded-lg flex flex-col gap-2">
